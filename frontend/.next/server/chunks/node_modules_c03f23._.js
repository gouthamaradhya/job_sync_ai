...
async function E(e, r) {
    ...
    if (c != null && c.subtle) {
        ...
        const { KJUR: l, KEYUTIL: u, b64utoutf8: f } = await __turbopack_require__("[project]/node_modules/@kinde/jwt-validator/dist/jsrsasign-B2gZIJhY.js [app-route] (ecmascript, async loader)")(__turbopack_import__).then((g)=>g.j), s = JSON.parse(f(t));
...
//# sourceMappingURL=node_modules_c03f23._.js.map